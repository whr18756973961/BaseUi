...
public final class SizeUtils {
    ...
    public static int dp2px(final float dpValue) {
        final float scale = UiCoreHelper.getProxy().getContext().getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(final float spValue) {
        final float fontScale = UiCoreHelper.getProxy().getContext().getResources().getDisplayMetrics().scaledDensity;
