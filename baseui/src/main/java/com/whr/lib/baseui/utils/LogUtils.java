    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                dir = UiCoreHelper.getProxy().getContext().getExternalCacheDir() + File.separator + "log" + File.separator;
            } else {
                dir = UiCoreHelper.getProxy().getContext().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
